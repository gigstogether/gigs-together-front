...
- `https://t.me/<bot_username>/admin` points to `https://<frontend-host>/admin/telegram`. This is the Telegram dispatcher for Gig and GigCandidate edit buttons generated by the backend.
