...
import { createAdminGigMainPost, patchAdminGigVisibility } from '@/app/admin/_lib/admin-api';
...
export function useAdminGigActions(params: UseAdminGigActionsParams) {
  ...
  const postMutation = useMutation({
    mutationFn: () => createAdminGigMainPost(params.publicId, params.expectedVersion),
    onSuccess: async () => {
