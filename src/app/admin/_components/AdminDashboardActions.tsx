...
export default function AdminDashboardActions() {
  ...
  const confirmCreateDigestPost = async (): Promise<void> => {
    try {
      await createDigestPostAsync();
  ...
  return (
    <section className="mb-8">
      ...
      >
        <DialogTrigger className="hidden">Open digest post confirmation dialog</DialogTrigger>
