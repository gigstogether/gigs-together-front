...
describe('createAdminGigMainPost', () => {
  beforeEach(() => {
    mockApiRequest.mockReset();
  });

  it('should create a Main post with the expected Gig version', async () => {
    mockApiRequest.mockResolvedValue(undefined);

    await expect(
      createAdminGigMainPost('radiohead-barcelona-2026-06-12', 4),
...
describe('createAdminDigestPost', () => {
  beforeEach(() => {
    mockApiRequest.mockReset();
  });

  it('should call the digest post endpoint', async () => {
    mockApiRequest.mockResolvedValue(undefined);

    await expect(createAdminDigestPost()).resolves.toBeUndefined();
